...
function Agenda() {
    ...
    const days = {
        "Pre-Hackathon": "Pre-Hackathon begins with a premium AI workshop for beginners, setting the stage for the event.",
        "Day 1": "Day one features registration, ceremonies, workshops, and company interactions.",
        "Overnight Stay.": "The overnight stay includes advanced workshops, gaming, stargazing, and hacking sessions extending into the next day.",
    ...
    return (
        <div className="flex flex-col w-screen bg-bg py-20">
            <div ref={preRef} className='w-full pb-48'>
                <Schedule styles='h-[20vh] lg:h-[15vh]' date={"28 February, 2025"} schedule={day1schedule} title={Object.keys(days)[0]} description={Object.values(days)[0]} divs={1} />
            </div>
            <div ref={mainRef} className='w-full'>
                <Schedule styles='h-[280vh] lg:h-[200vh]' date={"1 March, 2025"} schedule={day2schedule} title={Object.keys(days)[1]} description={Object.values(days)[1]} divs={12} />
            </div>
            <div ref={overnightRef} className='w-full'>
                <Schedule styles='h-[100vh] lg:h-[40vh]' date={"1-2 March, 2025"} schedule={day3schedule} title={Object.keys(days)[2]} description={Object.values(days)[2]} divs={4} />
            </div>
            <div ref={finalRef} className='w-full'>
                <Schedule styles='h-[200vh] lg:h-[120vh]' date={"8 March, 2025"} schedule={day4schedule} title={Object.keys(days)[3]} description={Object.values(days)[3]} divs={10} />
            </div>
        </div>
    );
}
