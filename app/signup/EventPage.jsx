...
export default function EventPage() {
  ...
  return (
    <div className="flex flex-col w-screen h-screen justify-center gap-6 items-center bg-bg">
      ...
      <h2 className="text-2xl md:text-[40px] leading-none">
        Registrations Closed.
      </h2>
      <div className="w-[26vw] mb-3 flex text-[#8a8ba0] justify-center text-center text-sm text-pretty">
        <span>
          We'll be back next year! If you have any questions, contact us at{" "}
          <a
      ...
      <SleekButtonBack
        text={"Return to home"}
        styles={"border-[#8a8ba0] text-[#8a8ba0] border-[0.5px] rounded-full"}
